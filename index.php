                ...
                <div class="col-lg-6">
                    <div class="section_title text-center mb-70">
                        <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s"
                            style="font-size: 50px; color:#57b846; margin-top: -110px;" id="services"> SERVICES OFFERED</span>
...
<h6 class="text-center mt-3">Copyright ©2020 All rights reserved<p style="color: green;">
            With 💙 by Preethi G
          </p>
